                                ...
                                @else
                                        <form action="{{ route('compra', $produto->id_produto) }}" method="POST">
                                            ...
                                            <div class="mb-4">
                                                ...
                                                <input type="number" name="quantidade" value="1" min="1" max="999" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500">
                                            </div>
                                            <button type="submit" class="w-full bg-green-600 hover:bg-green-700 text-black font-bold py-4 px-4 rounded-lg shadow-lg transform transition hover:scale-105 flex justify-center items-center gap-2">
